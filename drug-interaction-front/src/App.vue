  ...
  <div class="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 py-8 px-4">
    <div class="max-w-3xl mx-auto">
      ...
      <div class="text-center mb-8">
        ...
        <h1 class="text-3xl font-bold text-gray-900 mb-2">Drug Interaction Checker</h1>
        <p class="text-gray-600">Check for potential interactions between medications</p>
      </div>
